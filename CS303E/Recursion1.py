#  Description: Recursive programs practice
...
def changeXY(str):
    ...
    if (str[0] == 'x'):
        ...
        answer = str[0]
    return answer + changeXY(str[1:len(str)])
...
def countPairs(str):
    ...
    if (str[0] == str[2]):
        answer = answer + 1
    answer += countPairs(str[1:len(str)])
    return answer
...
#######################################################################################################
#                                                                                                     #
#                   Course code to test the above functions                                           #
#                                                                                                     #
#######################################################################################################
#######################################################################################################
def main(argv):
